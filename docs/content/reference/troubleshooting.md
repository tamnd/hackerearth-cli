...
Most of these come down to network reality or how hackerearth serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hackerearth rate-limits like any public site. he already paces
...
Where a surface is gated, he reads a cookie or token you supply
...
`he`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what he actually did
