...
import (
	...
	"github.com/tamnd/hackerearth-cli/pkg/render"
)
...
type App struct {
	client *hackerearth.Client
	cfg    hackerearth.Config
...
func Root() *cobra.Command {
	app := &App{cfg: hackerearth.DefaultConfig()}

	root := &cobra.Command{
		Use:   "he",
		Short: "Browse HackerEarth programming challenges",
		Long: `he reads HackerEarth practice problems and challenge listings from the public
pages — no API key required. It returns records as table, JSON, JSONL, CSV,
TSV, or URLs.

he is an independent tool and is not affiliated with HackerEarth.`,
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = hackerearth.NewClient(a.cfg)
	return nil
}
